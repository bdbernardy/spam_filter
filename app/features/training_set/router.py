...
async def get_all(
    ...
    return await get_all_texts(db, skip, limit)
...
async def add(
    ...
    """
    return await create_text(db, text)
...
async def update(
    ...
    return await update_text(db, id, text)
